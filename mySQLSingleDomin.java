...
class Cruds
{
	Cruds() 
	{
		...
		try
		{
			c = DriverManager.getConnection( "jdbc:mysql://165.22.14.77/dbSharvani","sharvani","pwdsharvani"); 
			...
			while (true)
			{
				...
				switch (option)
				{
					case 1:
						...
						break;
					case 2:
						display(c, "SELECT * FROM bankCustomerDetails;");
						break;
					case 3:
						finalize(c, stmt);
						System.exit(0);	
	...
	public static void create(Connection c, Statement stmt)
	{
		try
		{
			...
			String sql = "INSERT INTO bankCustomerDetails (accountNumber,name,balance,deleteStatus) " +
